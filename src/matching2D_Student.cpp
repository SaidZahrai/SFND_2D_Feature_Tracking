                      ...
                      double &t)
{
    ...
    { // nearest neighbor (best match)
        ...
        cout << matcherType << " and (NN) with n=" << matches.size() << " matches in " << 1000 * t / 1.0 << " ms" << endl;
    }
    ...
    { // k nearest neighbors (k=2)
        ...
        t = ((double)cv::getTickCount() - t) / cv::getTickFrequency();
        cout << matcherType << " and (KNN) with n=" << knn_matches.size() << " matches in " << 1000 * t / 1.0 << " ms" << endl;
